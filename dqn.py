...
class DQN:
    def __init__(self, env):
        ...
        # add trials to mem and use rand sample
        self.memory = deque(maxlen=2000)
        # future rewards depreciation factor
        self.gamma = 0.85
        # take a random action not the best in that scenario
        self.epsilon = 1.0
        self.epsilon_min = 0.01
        #  decay a each successive trial
        self.epsilon_decay = 0.995
        self.learning_rate = 0.005  # std learning rate param
        self.tau = 0.125
